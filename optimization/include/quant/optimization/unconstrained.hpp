...
public:
     ...
     */
    [[nodiscard]] static OptimizationResult global_minimum_variance(const Eigen::VectorXd& expected_returns,
     ...
     */
    [[nodiscard]] static OptimizationResult target_return_portfolio(const Eigen::VectorXd& expected_returns,
                                                                    const Eigen::MatrixXd& cov_matrix,
     ...
     */
    [[nodiscard]] static OptimizationResult maximum_sharpe_portfolio(const Eigen::VectorXd& expected_returns,
                                                                     const Eigen::MatrixXd& cov_matrix,
                                                                     double risk_free_rate = 0.02);
     ...
     */
    [[nodiscard]] static OptimizationResult risk_parity_portfolio(const Eigen::VectorXd& expected_returns,
                                                                  const Eigen::MatrixXd& cov_matrix,
                                                                  double risk_free_rate = 0.02,
